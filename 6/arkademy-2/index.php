...
<head>
    <title>Arkademy - Agustin Parmaini</title>
...
<body>
    <?php
    include "koneksi.php";
    $sql = "SELECT nama.id AS id_biodata, nama.name AS nama_diri, salary.id AS id_gaji, salary.salary AS jumlah_gaji, work.id AS id_pekerjaan, work.name AS nama_pekerjaan FROM nama INNER JOIN work ON nama.id_work = work.id INNER JOIN salary ON work.id_salary = salary.id";
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <select class="form-control" id="salarySelect" name="gaji" required>
                                <?php
                                $sql = "SELECT DISTINCT salary.id AS id_gaji, salary.salary AS jumlah_gaji FROM salary";
                                $result = mysqli_query($conn, $sql);
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ?>

...
if ($_POST['id']) {
    ...
    $sql = "SELECT nama.id AS id_biodata, nama.name AS nama_diri, salary.id AS id_gaji, salary.salary AS jumlah_gaji, work.id AS id_pekerjaan, work.name AS nama_pekerjaan FROM nama INNER JOIN work ON nama.id_work = work.id INNER JOIN salary ON work.id_salary = salary.id WHERE nama.id = $id";
